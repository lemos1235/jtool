...
public final class XxJavaTimeModule extends SimpleModule {
    private static final long serialVersionUID = 1L;

    public XxJavaTimeModule() {
        ...
        addDeserializer(LocalDateTime.class, new LocalDateTimeDeserializer(DateTimeFormatter.ofPattern(CommonConstant.PATTERN_DATETIME)));
        addDeserializer(LocalDate.class, new LocalDateDeserializer(DateTimeFormatter.ofPattern(CommonConstant.PATTERN_DATE)));
        ...
        addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(DateTimeFormatter.ofPattern(CommonConstant.PATTERN_DATETIME)));
        addSerializer(LocalDate.class, new LocalDateSerializer(DateTimeFormatter.ofPattern(CommonConstant.PATTERN_DATE)));
